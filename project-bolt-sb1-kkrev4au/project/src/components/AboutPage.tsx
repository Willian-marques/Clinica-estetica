      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div data-aos="fade-right">
            <h2 className="text-3xl font-bold text-gray-800 mb-6" data-aos="fade-down">Nossa História</h2>
            <p className="text-gray-600 mb-4 leading-relaxed" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="mb-20">
          ...
          <p className="text-lg text-gray-600 text-center mb-12 max-w-2xl mx-auto" data-aos="fade-down" data-aos-delay="100">
        ...
        {/* Nossos Diferenciais */}
        <div>
          <h2 className="text-3xl font-bold text-gray-800 text-center mb-12" data-aos="fade-down">
            Nossos Diferenciais
          </h2>
          ...
          <div className="space-y-8">
            {[
              ...
              <div key={index} className="flex items-start space-x-6" data-aos="fade-right" data-aos-delay={index * 100}>
